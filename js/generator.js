(function() {
  ...
  function renderTidalLink(song) {
    return `
      <a href=${song.tidalLink} target="_blank">▶︎ Listen to ${
      song.title
    } on TIDAL</a>
    `;
  }
  ...
  function renderAscii(lyrics, pxon) {
    ...
    DOM.generateButton.innerHTML =
      'Generate ASCII <span class="btn-icon btn-icon--right" aria-hidden="true">&rarr;</span>';
  }
  ...
  DOM.imageDragContainer.addEventListener(
    "dragenter",
    onDragEnterImageDragContainer
  );
